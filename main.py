...
def load_db():
    ...
    try:
        ...
        mongodb_payment_collection = mongodb_name[mongodb_config["mongodb_collection"]["payment"]]
    ...
    return backup_db, backup_folder_user, mongodb_user_collection, mongodb_payment_collection

backup_db, backup_folder_user, mongodb_user_collection, mongodb_payment_collection = load_db()
...
def topup_webhook():
    try:
        ...
        result, status_code = updater.update_balance(backup_db, backup_folder_user, mongodb_user_collection, mongodb_payment_collection, topup_data)
